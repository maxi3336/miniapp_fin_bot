...
const formSchema = z.object({
  ...
  category: z.string({ required_error: "Категория обязательна!" }).min(0, {
    message: "Категория не может быть пустой",
  }),
  amount: z.number({ required_error: "Сумма обязательна!" }).min(0, {
    message: "Сумма не может быть пустой",
  }),
  account: z.string({ required_error: "Счёт обязателен!" }).min(0, {
    message: "Счёт не может быть пустой",
  }),
  comment: z
    .string({ required_error: "Комментарий обязателен!" })
    .min(0, {
